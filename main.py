...
def filter_voice(sig, rate, gains, nband=13, lowfreq=20, highfreq=8000):
...
def voice_denoise(sig, rate, model, timestamp_size, numcep=13, plot=False):
    sig = sig / 32768
...
def main():
    ...
    history = train(x_train, y_train, vad_train, batch_size=timestamp_size, epochs=100, model_name="model.h5")
